...
- **프로젝트 허브**: https://www.notion.so/371f66a55e938112ba25c84f922cccf3
...
- 워크플로: https://aigw2026.app.n8n.cloud/workflow/GShLyUWZH8rMcPVt
...
- 모든 결과는 n8n **Data Table**(`s7lc68owevdCH6wV`)에 자동 기록 → 실습생 추이·코호트 분석
...
(execution #97·#98 — 모두 `success`, 장애유형별 적합화 정확 전환, Data Table 기록 누적 확인)
